...
// SQLite diagonal stripe pattern styling
const cardStyle = {
  '--s': '150px',
  '--c1': '#76cdec',
  '--c2': '#001d38',
  opacity: '0.8',
  background: 'linear-gradient(135deg,#0000 18.75%,var(--c1) 0 31.25%,#0000 0), repeating-linear-gradient(45deg,var(--c1) -6.25% 6.25%,var(--c2) 0 18.75%)',
...
<template>
  ...
  >
    ...
    <CardContent class="pt-0 pb-2 h-full flex items-center justify-center">
      <span class="inline-block max-w-full rounded-md text-teal-600 dark:text-white
...
.dark .dot-pattern-display {
  ...
  --c1: #76cdec !important;
  --c2: #001d38 !important;
  background: linear-gradient(135deg,#0000 18.75%,var(--c1) 0 31.25%,#0000 0), repeating-linear-gradient(45deg,var(--c1) -6.25% 6.25%,var(--c2) 0 18.75%) !important;
