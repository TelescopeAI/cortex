<template>
  <div class="space-y-6">
    ...
    <div v-if="showAutoGenerated !== false && autoGeneratedJoins.length > 0" class="space-y-3">
    ...
    <div class="space-y-3">
      ...
      <div v-if="customJoins.length === 0 && showEmptyState !== false" class="text-center py-8 border-2 border-dashed rounded-lg">
